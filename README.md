...
<body>
  ...
  <p>Maintained by Sanjeev Preetam K</p>
...
with open("regressor_model.pkl", 'wb') as file:
  ...
  <p>
    ...
    Sanjeev is a Data Analyst with 4+ years of experience architecting end-to-end data solutions, developing advanced machine learning models, and orchestrating scalable analytics workflows.
    He has demonstrated success in deploying AI-driven systems using Python, PyTorch, and cloud technologies (AWS, GCP) to derive meaningful insights and accelerate business intelligence.
    His key skills include Pandas, NumPy, and Scikit-learn.
  </p>
  <h3>Contact</h3>
  <ul>
    <li>GitHub: https://github.com/AnanditaNagpal
    <li>LinkedIn: https://www.linkedin.com/in/anandita-nagpal
